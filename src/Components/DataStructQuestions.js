...
import { DS_QUESTIONS } from "../Constants";
...
class DataStructQuestions extends Component {
	initialState = {
		...
		totalQuestions: DS_QUESTIONS.length,
	...
	render() {
		const questionString = DS_QUESTIONS[this.state.questionIndex].question;
		const answerString = DS_QUESTIONS[this.state.questionIndex].answer;
